...
<body>
  ...
  <div class="col-md-2">    
      ...
      <div class="col-md-8">
          <h1><b style="font-size: 50px;color: #21618C; font-family: comic sans MS">Fertilizer Selling System</b></h1>
      </div> 
      <div class="col-md-2">    
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
       ...
       <a href="home.php" style="color: white">  <button class="btn1"><i class="fa fa-home"></i> Home</button></a>
	   ...
	   <a href="afterlgn.php" style="color: white"><button class="btn1"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Buy Fertilizer</button></a>
       </ul>
        
    
  <ul class="nav navbar-nav navbar-right">
     <button class="btn1"><i class="fa fa-user"></i><?php echo "Welcome ".$us;?></button>
